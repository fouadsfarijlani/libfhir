...
use crate::r4::{
    elements::{
        Address, Attachement, BackboneElement, CodeableConcept, ContactPoint, Element, HumanName, Identifier, Period, Reference,
    },
    resources::{
        DomainResource, Gender, Organization, Practitioner, PractitionerQualification,
        Resource,
    },
};
